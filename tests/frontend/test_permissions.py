...
class Test_040_Permissions_User(FrontendDataTestBase):
    ...
    def test_0040_access_infrastructure(self):
        for url in (
            ...
            url_for('infrastructure.arecord_edit', user_id=1, record_id=1),
            url_for('infrastructure.aaaarecord_edit', user_id=1, record_id=1),
            url_for('infrastructure.cnamerecord_edit', user_id=1, record_id=1),
            url_for('infrastructure.mxrecord_edit', user_id=1, record_id=1),
            url_for('infrastructure.nsrecord_edit', user_id=1, record_id=1),
            url_for('infrastructure.srvrecord_edit', user_id=1, record_id=1),
